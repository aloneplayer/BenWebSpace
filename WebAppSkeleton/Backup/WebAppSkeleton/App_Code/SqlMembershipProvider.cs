...
namespace System.Web.Security
{
    public class SqlMembershipProvider : MembershipProvider
    {
        ...
        public override bool ChangePasswordQuestionAndAnswer(string username, string password, string newPasswordQuestion, string newPasswordAnswer)
        {
            ...
            {
                str2 = base.EncodePassword(newPasswordAnswer.ToLower(CultureInfo.InvariantCulture), num, str);
            }
            else
            {
        ...
        private string GetEncodedPasswordAnswer(string username, string passwordAnswer)
        {
            ...
            return base.EncodePassword(passwordAnswer.ToLower(CultureInfo.InvariantCulture), num2, str2);
        }
        ...
        Label_025C:
            ...
            {
                throw new ProviderException(System.Web.SR.GetString("Connection_string_not_found", new object[] { specifiedConnectionString }));
            }
        ...
        public override string ResetPassword(string username, string passwordAnswer)
        {
            ...
            if (num2 == 0)
            {
                ...
                if (!string.IsNullOrEmpty(passwordAnswer))
                {
                    str3 = base.EncodePassword(passwordAnswer.ToLower(CultureInfo.InvariantCulture), num, str);
                }
                else
                {
                    str3 = passwordAnswer;
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        command.Parameters.Add(this.CreateInputParam("@ApplicationName", SqlDbType.NVarChar, this.ApplicationName));
                        command.Parameters.Add(this.CreateInputParam("@UserName", SqlDbType.NVarChar, username));
                        command.Parameters.Add(this.CreateInputParam("@NewPassword", SqlDbType.NVarChar, base.EncodePassword(password, num, str)));
                        command.Parameters.Add(this.CreateInputParam("@MaxInvalidPasswordAttempts", SqlDbType.Int, this.MaxInvalidPasswordAttempts));
                        command.Parameters.Add(this.CreateInputParam("@PasswordAttemptWindow", SqlDbType.Int, this.PasswordAttemptWindow));
